...
public class MainN2 extends JFrame  {
    ...
    public static void lancerFenetre() {
        ...
        Cellule moveCell = new Cellule(TypeCell.MOVE, Action.MOVE, Orientation.EAST, new Case(1,3));
        Cellule pusherCell2 = new Cellule(TypeCell.PUSHER, Action.PUSH, Orientation.EAST, new Case(3,3));
        Cellule pusherCell3 = new Cellule(TypeCell.DIRECTIONAL, Action.PUSH, Orientation.WEST, new Case(4,3));
        ...
        tableau.ajouterCellule(moveCell, 1, 3); 
        tableau.ajouterCellule(pusherCell2, 3, 3);
        tableau.ajouterCellule(pusherCell3, 4, 3);
        ...
        // Créer une cellule à déplacer et ajouter un pusher
                cellulesInit.add(new Cellule(TypeCell.MOVE, Action.MOVE, Orientation.EAST,  new Case(1, 3)));
       
                cellulesInit.add(new Cellule(TypeCell.PUSHER, Action.PUSH, Orientation.WEST,new Case(3, 3)));

                cellulesInit.add(new Cellule(TypeCell.DIRECTIONAL, Action.PUSH, Orientation.WEST,new Case(4, 3)));
                
                cellulesInit.add(new Cellule(TypeCell.ENEMY, Action.NONE, Orientation.SOUTH,new Case(7, 3)));
                
                cellulesInit.add(new Cellule(TypeCell.ENEMY, Action.NONE, Orientation.SOUTH, new Case(8, 3)));
...
public class MainN2 extends JFrame  {
    ...
    public static void lancerFenetre() {
        ...
        Cellule Ennemycell1 = new Cellule(TypeCell.ENEMY, Action.MOVE, Orientation.SOUTH, new Case(7, 3));
        Cellule Ennemycell2 = new Cellule(TypeCell.ENEMY, Action.MOVE, Orientation.SOUTH, new Case(8, 3));
        Cellule directional = new Cellule(TypeCell.DIRECTIONAL, Action.PUSH, Orientation.WEST,new Case(2, 3));

        tableau.ajouterCellule(moveCell, 1, 3); 
        tableau.ajouterCellule(pusherCell2, 3, 3);
        tableau.ajouterCellule(Ennemycell1 , 7, 3);
        tableau.ajouterCellule(Ennemycell2, 8, 3);
        tableau.ajouterCellule(directional, 2, 3);
        ...
        // Créer une cellule à déplacer et ajouter un pusher
                ...
                cellulesInit.add(new Cellule(TypeCell.DIRECTIONAL, Action.PUSH, Orientation.WEST,new Case(2, 3)));
