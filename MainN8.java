...
public class MainN8 extends JFrame{
    ...
    public static void lancerFenetre() {
        ...
        Tableau tableau = new Tableau(7, 7);
        for (int x = 1; x < 6; x++) {
            for (int y = 1; y < 6; y++) {
        ...
        Cellule cellule = new Cellule(TypeCell.MOVE, Action.MOVE, Orientation.EAST, new Case(1, 3));
        
        Cellule cellule2 = new Cellule(TypeCell.TELEPORTOR, Action.TELEPORT, Orientation.EAST, new Case(2,3));

        Cellule e1 = new Cellule(TypeCell.ENEMY, Action.MOVE, Orientation.SOUTH, new Case(6, 3));
    
        tableau.ajouterCellule(cellule, 1,3);
        tableau.ajouterCellule(cellule2, 2, 3);
        

        tableau.ajouterCellule(e1, 6, 3);
        

            // --- Création de la fenêtre ---
            JFrame frame = new JFrame("Level 8");
            ...
            // Créer une cellule à déplacer et ajouter un pusher
                ...
                cellulesInit.add(new Cellule(TypeCell.TELEPORTOR, Action.TELEPORT, Orientation.SOUTH, new Case(2, 3)));
