...
public class MainN1 extends JFrame  {
    ...
    public static void lancerFenetre() {
        ...
        Cellule moveCell = new Cellule(TypeCell.MOVE, Action.MOVE, Orientation.EAST, new Case(2,2));
        Cellule Ennemycell = new Cellule(TypeCell.ENEMY, Action.MOVE, Orientation.SOUTH, new Case(8, 3));

        tableau.ajouterCellule(moveCell, 2, 2);
        tableau.ajouterCellule(Ennemycell , 8, 3);
            ...
            restartButton.addActionListener(e -> {
                ...
                cellulesInit.add(new Cellule(TypeCell.MOVE, Action.MOVE, Orientation.EAST, new Case(2,2)));
